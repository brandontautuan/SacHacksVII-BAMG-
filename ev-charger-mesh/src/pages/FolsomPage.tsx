/**
 * Folsom mesh map: charger simulation + Grid Governor agent + graph view.
 */
...
const rawRows = folsomChargersJson as StationInput[]

export function FolsomPage() {
        ...
        {viewMode === 'graph' && (
          <>
            ...
            >
              ...
              >
                Average P_fail vs days (real-time)
              </div>
